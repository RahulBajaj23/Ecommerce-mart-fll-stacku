                    ...
                    <div className='' onClick={handleshowMenu}>
                        ...
                        {showMenu && (
                            <div className='absolute right-2 bg-white py-2 px-2 shadow drop-shadow-md flex flex-col'>
                                <Link to={"newproducts"} className='whitespace-nowrap cursor-pointer'>New Products</Link>
                                {
                                    userData.email ? <p className='cursor-pointer text-red-700' onClick={handleLogout}>Logout</p> : <Link to={"login"} className='whitespace-nowrap cursor-pointer text-blue-700'>Login</Link>
                                }
